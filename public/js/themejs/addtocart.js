...
var cart = {
    'add': function(product_id, quantity) {
        addProductNotice('Producto añadido al carrito', '<img src="image/demo/shop/product/e11.jpg" alt="">', '<h3><a href="#">Apple Cinema 30"</a> added to <a href="#">shopping cart</a>!</h3>', 'success');
    }
}
