                ...
                <div class="modcontent">
                    <div class="box-category">
                        <ul id="cat_accordion" class="list-group">
                            @for ($i = 0; $i < 8; $i++)
                            <li class=""><a href="#" class="cutom-parent">Categoria</a>  <span class="dcjq-icon"></span></li>
                            @endfor
            ...
            <div class="products-category">
                        ...
                        <div class="product-item-container item--static">
                            <div class="left-block">
                                <div class="product-image-container second_img">
                                    <a href="producto/{{$r->slug}}" target="_self" title="{{$r->descripcionCorta}}">
                                        <img src="{{ $r->imagen }}" class="img-1 img-responsive" alt="{{$r->descripcionCorta}}">
                                        <img src="{{ $r->imagen }}" class="img-2 img-responsive" alt="{{$r->descripcionCorta}}">
                                    </a>
                                </div>
                            ...
                            <div class="right-block">
                                ...
                                <h4><a href="#" title="{{ $r->descripcionCorta }}" target="_self">{{ $r->descripcionCorta }}</a></h4>
                                ...
                                <div class="price">
                                  <span class="price">{{ $r->precio }}</span>
                                </div>
                ...
                <div class="product-filter product-filter-bottom filters-panel">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">mostrando 1 de 12  (1 Pagina)</div>
                    </div>
                </div>
                <!-- //end Filters -->
