...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="/admin/assets/images/favicon-32x321.png" type="image/png" />
    <!--plugins-->
    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div>
                    <img src="https://www.abasleal.com/img/logo_450.png" class="logo-icon"
                        style="width:150px; height:auto;" alt="logo icon">
                </div>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('compras') }}" class="has-arrow">
                ...
                <li>
                    <a href="{{ route('perfil') }}" class="has-arrow">
                        <div class="parent-icon"><i class='bx bx-user'></i>
                        </div>
                        <div class="menu-title">Mis datos</div>
                    </a>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                            ...
                            <img src="/admin/assets/images/avatars/avatar-1.png" class="user-img"
                                alt="user avatar">
                            <div class="user-info ps-3">
                                <p class="user-name mb-0">Alfredo Galvan</p>
                                <p class="designattion mb-0">alfredogalvan.91@gmail.com</p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="javascript:;"><i
                                        class="bx bx-cog"></i><span>Configuración</span></a>
                            </li>
